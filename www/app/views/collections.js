...
mobi.views.CollectionsInnerList = Ext.extend(Ext.List, {
    ...
    listeners: {
        itemtap: function (list, index, element, event) {
            ...
            fetchProductsList(record.raw._id);
...
mobi.views.CollectionsList = Ext.extend(Ext.Panel, {
	id: 'collections_list',
    layout: 'fit',
    dockedItems: [{
        xtype: 'toolbar',
    ...
    items: [
        ...
        new mobi.views.CollectionsInnerList({
